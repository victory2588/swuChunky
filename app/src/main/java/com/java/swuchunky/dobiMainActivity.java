...
public class dobiMainActivity extends FragmentActivity {
    ...
    private Fragment dobi_main, dobi_mypage, dobi_apply, dobi_findWork1; //네비게이션을 통해 이동할 프래그먼트
        ...
        dobi_menu.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener(){
            ...
            public boolean onNavigationItemSelected (@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_dobi_apply) {
                    getSupportFragmentManager().beginTransaction().replace(R.id.menu_containers, dobi_apply).commit();
                    return true;
                }
                //검색(예약하기) 선택
